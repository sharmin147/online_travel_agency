...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('flight_segments', function (Blueprint $table) {
            ...
            $table->bigInteger('departure_city', 255)->nullable();
            $table->bigInteger('arrival_city', 255)->nullable();
            $table->bigInteger('departure_airport', 255)->nullable();
            $table->bigInteger('arrival_airport', 255)->nullable();
            $table->date('departure_date')->nullable();
            $table->date('arrival_date')->nullable();
            $table->boolean('is_direct_flight');
            $table->string('connection_airport')->nullable();
            $table->time('connection_duration')->nullable();
