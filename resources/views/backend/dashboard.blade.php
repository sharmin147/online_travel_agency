                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      <div class="col-4 col-sm-3 col-xl-2">
                        <img src="{{asset('public/assets/images/dashboard/Group126@2x.png')}}" class="gradient-corona-img img-fluid" alt="">
                      </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{asset('public/assets/images/faces/face2.jpg')}}"alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{asset('public/assets/images/faces/face5.jpg')}}" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{asset('public/assets/images/faces/face3.jpg')}}"alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{asset('public/assets/images/faces/face4.jpg')}}"alt="image" />
