                        ...
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data" action="{{route('user.store')}}">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                           <label for="roleId" style="color: green;">Role  <i class="text-danger">*</i></label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="userName_en" style="color: green;">Name (English) <i class="text-danger">*</i></label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="userName_bn" style="color: green;">Name (Bangla)</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="EmailAddress" style="color: green;">Email <i class="text-danger">*</i></label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="contactNumber_en" style="color: green;">Contact Number (English) <i class="text-danger">*</i></label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="contactNumber_bn" style="color: green;">Contact Number (Bangla)</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="status" style="color: green;">Status</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="fullAccess" style="color: green;">Full Access</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="password" style="color: green;">Password <i class="text-danger">*</i></label>
