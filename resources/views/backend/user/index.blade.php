                    ...
                    <table class="table table-bordered mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="color: green; font-size: 16px">{{__('Email')}}</th>
                                <th scope="col" style="color: green; font-size: 16px">{{__('Contact')}}</th>
                                <th scope="col" style="color: green; font-size: 16px">{{__('Role')}}</th>
                                <th scope="col" style="color: green; font-size: 16px">{{__('Image')}}</th>
                                <th scope="col" style="color: green; font-size: 16px">{{__('Status')}}</th>
